...
public class Randomization {
    public static void generateAndSave2DCarpet(Location center, int difficulty) {
        if (difficulty < 7) {
            generateAndSave2DCarpet(center, ((difficulty + 1) / 2) + 1, (difficulty + 2) / 3, difficulty);
        } else {
            generateAndSave2DCarpet(center, 4, (difficulty + 2) / 3, difficulty);
        }
    }
    public static void generateAndSave3DBlocks(Location center, int difficulty) {
        if (difficulty < 7) {
            generateAndSave3DBlocks(center, ((difficulty + 1) / 2) + 1, (difficulty + 2) / 3, difficulty);
        } else {
            generateAndSave3DBlocks(center, 4, (difficulty + 2) / 3, difficulty);
        }
    }
    public static void generateAndSave3DBlocks(Location center, int size, int colorCount, int blockCount) {
        ...
        File file = new File(directory, "RR3D.txt");
    ...
    private static void generateAndSave2DCarpet(Location center, int size, int colorCount, int blockCount) {
        World world = center.getWorld();
        Random random = new Random();
        ...
        File directory = new File("build_master_saves");
        File file = new File(directory, "RR2D.txt");
